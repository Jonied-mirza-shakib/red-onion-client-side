...
const Dinner = () => {
  ...
  useEffect(() => {
    fetch('https://red-onion-server-side.vercel.app/dinner')
      .then(res => res.json())
  ...
  return (
   <div className='bg-base-200'>
     <div style={{ width: '90%', margin: 'auto', paddingTop: '80px',paddingBottom:'50px' }}>
      <h1 className='text-5xl text-center uppercase' style={{ fontFamily: 'Roboto Mono, monospaced', fontWeight: 'bold', color: 'black' }}>DINNER</h1>

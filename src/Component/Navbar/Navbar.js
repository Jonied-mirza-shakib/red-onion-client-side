...
const Navbar = () => {
    ...
    return (
        // <div className="navbar py-3 sticky top-0 bg-white lg:justify-between">
        ...
        //             </ul>
        //         </div>
        //         <a className="btn btn-ghost normal-case text-xl"><img style={{width:'150px',height:'auto'}} src={logo} alt=""/></a>
        //     </div>
...
<div className="navbar bg-base-100">
    <div className="navbar-start">
        ...
        <a className="btn btn-ghost normal-case text-xl">VENIA COSMETIC</a>
    </div>
    <div className="navbar-center hidden lg:flex">
        <ul className="menu menu-horizontal p-0">
        {menuItem}
    ...
    <label tabIndex="1" htmlFor="my-drawer" className="btn btn-ghost lg:hidden">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
    </label>
</div>
</div>
